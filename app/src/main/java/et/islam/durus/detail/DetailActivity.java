...
import et.islam.durus.player.MusicManager;
import et.islam.durus.player.VideoPlayManager;
import et.islam.durus.reader.Reader;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private void getLinks() {
        try {
            DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Durus").child("content").child(ustaz).child(course_name).child(part_number);
